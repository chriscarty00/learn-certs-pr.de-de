...
Führen Sie jetzt einen Systemtest durch, um zu sehen, ob Ihr Computer und Standort kompatibel mit der Online-Proctoring-Software sind, bevor Sie Ihre Prüfung planen.
...
2. **Vergewissern Sie sich, dass Ihre ID konform ist (lesen Sie die [Anforderungen](https://home.pearsonvue.com/Policies/1S/English)) und dass der Name in Ihrem Profil genau mit Ihrer Identifikation übereinstimmt.**  
...
- Stellen Sie sicher, dass Sie über Administratorrechte auf Ihrem Computer verfügen, damit Sie die Testsoftware herunterladen können.

So starten Sie Ihre Tests und stellen die Verbindung zu einem Begrüßer her:

- Melden Sie sich bei [Ihrem Zertifizierungs-Dashboard](https://www.microsoft.com/learning/dashboard.aspx).
- Wählen Sie rechts im Abschnitt **Termine** die Option **Eine zuvor geplante online beaufsichtigte Prüfung starten**.
- Die von Ihnen geplante Prüfung wird angezeigt. Wählen Sie den Prüfungslink und dann **Prüfung beginnen**.

**Hinweis** Sie können bis zu fünf Minuten warten, bevor Sie eine Verbindung mit einem Begrüßer herstellen.
...
Auf Ergebnisberichte kann über [Ihr Zertifizierungs-Dashboard](https://www.microsoft.com/learning/dashboard.aspx).

- Melden Sie sich bei [Ihrem Zertifizierungs-Dashboard](https://www.microsoft.com/learning/dashboard.aspx).
- Wählen Sie **Meinen Ergebnisbericht anzeigen**. Von hier aus können Sie Ihren Bewertungsbericht speichern und drucken.
...
Bitte überprüfen Sie die aktuelle [ID-Richtlinie](https://home.pearsonvue.com/Policies/1S/English). Beachten Sie, dass Namensänderungsformulare, darunter Ausweis-Erneuerungsformulare, nicht für die online Bereitstellung verwendet werden können, falls Ihr Ausweis derzeit bearbeitet oder erneuert wird.
