...
* Microsoft Imagine Academy (für berechtigte Organisationen)

  Das Microsoft Imagine Academy-Programm (MSIA) ist ein Qualifizierungsprogramm, das Technologiekurse, Lehrmaterialien und damit zusammenhängende Leistungen anbietet, die auf gefragte Qualifikationen für Arbeitsmarkt und Karriere ausgerichtet sind. Umfassende Lernpfade und Lehrpläne bereiten die Lernenden darauf vor, erfolgreich eine von der Industrie anerkannte Zertifizierung und eine Anstellung zu erlangen. Zu den Lernmaterialien gehören Lehrpläne zur Zertifizierungsvorbereitung für Microsoft Office Specialist, Microsoft Technology Associate und Microsoft Fundamentals.

  Die Microsoft Imagine Academy bietet:

  * 30 Gutscheine für kostenlose Zertifizierungsprüfungen im Rahmen der beruflichen Weiterbildung von Lehrkräften/Mitarbeitern (MOS, MTA, Grundlagen und MCE) gemäß VL-Vereinbarung (auf alle Schulen verteilt).
  * Pakete mit Kursinhalten für Produktivitätskurse (MOS) und IT-Einstiegskurse (MTA) – MOAC.
  * Prüfungshandbücher für MOS 2016 und MOS 2019/O365.
  * 50 % Rabatt auf das MCT-Programm (Microsoft Certified Trainer).
  * Zugriff auf Microsoft Official Courseware-Inhalte (MOC).
  * Individuell gestaltbare Kursabschlusszertifikate.
  * 40 % Rabatt auf Microsoft Press-Bücher.

  Der Zugang zur Microsoft Imagine Academy (MSIA) steht bei Neukauf oder Verlängerung von Volumenlizenzabonnements für EES (Enrollment for Education Solutions), School und OVS-ES (Open Value Subscription – Education Enrollment-Abonnements) als Programmvorteil ohne zusätzliche Kosten zur Verfügung.
...
* Kontakt
  ...
  [Kontaktieren Sie unsere Vertriebsspezialisten, um sich über die Trainings- und Zertifizierungslösungen von Microsoft zu informieren](mailto:mslvlhlp@microsoft.com).
...
**Frage: Wenn ich nicht alle während der Vertragslaufzeit erworbenen Codes nutze, oder wenn ein Mitarbeiter kündigt, kann ich den Code einem anderen Mitarbeiter zuweisen oder eine Rückerstattung für die nicht genutzten Codes erhalten?**
...
- Die Anzahl der Personen in Ihrer Organisation, die zertifiziert werden sollen.
